    ...
    <footer className="border-t-2 border-border bg-secondary-background pb-20 md:pb-0">
      <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2">
          <h2 className="font-heading text-xl mb-1">Feux de la Rose Noire</h2>
        ...
        <div className="space-y-2">
          {admin?.email && (
            <a href={`mailto:${admin.email}`} className="flex items-center gap-2 text-sm hover:text-main transition-colors duration-200">
              <Mail className="size-4 shrink-0 text-main" />
              {admin.email}
            </a>
          )}
          {admin?.phone && (
            <a href={`tel:${admin.phone}`} className="flex items-center gap-2 text-sm hover:text-main transition-colors duration-200">
      ...
      <div className="border-t border-border/20 py-4 text-center text-xs text-foreground/25">
